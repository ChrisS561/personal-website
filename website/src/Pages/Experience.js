		...
		<>
			...
			<div className="experience">
				<VerticalTimeline lineColor="#dedede">
					...
					>
						<h3 className="vertical-timeline-element-title">Southwestern University</h3>
					...
					>
						...
						<h4 className="vertical-timeline-element-subtitle">Network Services Intern</h4>
						<p className="subtext">Austin, TX</p>
					...
					<VerticalTimelineElement
						...
						icon={<FontAwesomeIcon icon={faGraduationCap} />}
					>
						<h3 className="vertical-timeline-element-title">Mountain View College</h3>
						<h4 className="vertical-timeline-element-subtitle">Associate's degree in Fine Arts</h4>
					...
					<VerticalTimelineElement
						...
						icon={<FontAwesomeIcon icon={faGraduationCap} />}
					>
						<h3 className="vertical-timeline-element-title">Clearlake Christian High School</h3>
